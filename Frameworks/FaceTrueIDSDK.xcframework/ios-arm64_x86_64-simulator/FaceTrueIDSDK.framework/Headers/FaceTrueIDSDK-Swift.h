...
- (nonnull instancetype)initWithDomain:(NSString * _Nonnull)domain domainPath:(NSString * _Nonnull)domainPath authDomain:(NSString * _Nonnull)authDomain authDomainPath:(NSString * _Nonnull)authDomainPath appId:(NSString * _Nonnull)appId appSecret:(NSString * _Nonnull)appSecret requestId:(NSString * _Nonnull)requestId accessToken:(NSString * _Nonnull)accessToken OBJC_DESIGNATED_INITIALIZER;
