...
#ifndef FACETRUEIDSDK_SWIFT_H
#define FACETRUEIDSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FaceTrueIDSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13FaceTrueIDSDK18ConfigFaceEndPoint")
@interface ConfigFaceEndPoint : NSObject
@property (nonatomic, copy) NSString * _Nonnull selfie;
@property (nonatomic, copy) NSString * _Nonnull authen;
@property (nonatomic, copy) NSString * _Nonnull enroll;
...
SWIFT_CLASS("_TtC13FaceTrueIDSDK17ConfigInfoFaceSDK")
@interface ConfigInfoFaceSDK : NSObject
...
- (nonnull instancetype)initWithDomain:(NSString * _Nonnull)domain configEndPoint:(ConfigFaceEndPoint * _Nonnull)configEndPoint appId:(NSString * _Nonnull)appId appSecret:(NSString * _Nonnull)appSecret requestId:(NSString * _Nonnull)requestId accessToken:(NSString * _Nonnull)accessToken configHeader:(NSString * _Nonnull)configHeader OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC13FaceTrueIDSDK15ConfigUIFaceSDK")
@interface ConfigUIFaceSDK : NSObject
...
- (nonnull instancetype)initWithPrimaryColor:(NSString * _Nonnull)primaryColor secondaryColor:(NSString * _Nonnull)secondaryColor backgroundColor:(NSString * _Nonnull)backgroundColor textColor:(NSString * _Nonnull)textColor textButtonColor:(NSString * _Nonnull)textButtonColor borderInputColor:(NSString * _Nonnull)borderInputColor errorColor:(NSString * _Nonnull)errorColor closeColor:(NSString * _Nonnull)closeColor stepBarColor:(NSString * _Nonnull)stepBarColor stepBarBackgroundColor:(NSString * _Nonnull)stepBarBackgroundColor fontName:(NSString * _Nonnull)fontName borderRadius:(NSInteger)borderRadius defaultSpacing:(NSInteger)defaultSpacing maxRetry:(NSInteger)maxRetry livenessType:(NSString * _Nonnull)livenessType imageConfirmation:(BOOL)imageConfirmation trueidWatermark:(BOOL)trueidWatermark allowEditOcr:(BOOL)allowEditOcr hasInstroctions:(BOOL)hasInstroctions isManualSelfie:(BOOL)isManualSelfie isShowStepBar:(BOOL)isShowStepBar steps:(NSInteger)steps currentStep:(NSInteger)currentStep positionBackInitCamera:(BOOL)positionBackInitCamera isDisableSecurity:(BOOL)isDisableSecurity errorTime:(NSInteger)errorTime OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC13FaceTrueIDSDK6FaceID")
@interface FaceID : NSObject
+ (void)configureWithConfigInfo:(ConfigInfoFaceSDK * _Nonnull)configInfo configUI:(ConfigUIFaceSDK * _Nonnull)configUI;
+ (void)startWithListener:(void (^ _Nonnull)(facesdkResult * _Nonnull))listener;
+ (void)startFaceAuthenWithUserID:(NSString * _Nonnull)userID listener:(void (^ _Nonnull)(facesdkResult * _Nonnull))listener;
+ (void)startFaceEnrollWithUserID:(NSString * _Nonnull)userID listener:(void (^ _Nonnull)(facesdkResult * _Nonnull))listener;
...
SWIFT_CLASS("_TtC13FaceTrueIDSDK12TrueIDClient")
@interface TrueIDClient : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13FaceTrueIDSDK13facesdkResult")
@interface facesdkResult : NSObject
...
@property (nonatomic, copy) NSString * _Nullable rawImage;
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable facesdkResult;
